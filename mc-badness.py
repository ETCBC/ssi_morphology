...
# strings of the second and third field are passed to code_distance().
   ...
   with open(path) as f:
      for line in f:
         ...
         if len(l) >= 4 and l[3] == "wrong":
            print(l[0], l[1], l[2], l[3], code_distance(l[1], l[2]))


from sys import argv, stderr

def Usage():
   stderr.write('usage: mc-badness [-b base] [-l language] file...\n')
   exit(1)
